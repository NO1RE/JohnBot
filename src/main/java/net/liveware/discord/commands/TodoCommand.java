...
public class TodoCommand extends Command
{
    ...
    public static final String ADD_TOUHOU_CHARCATER = "addTouhouCharacter";
    public static final String GET_TOUHOU_CHARCATER = "getTouhouCharacter";
    public static final String SET_TOUHOU_CHARCATER = "setTouhouCharacter";
    public static final String REMOVE_TOUHOU_CHARCATER = "removeTouhouCharacter";
