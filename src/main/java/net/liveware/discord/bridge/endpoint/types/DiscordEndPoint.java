 ...
 */
package net.liveware.discord.bridge.endpoint.types;

import net.dv8tion.jda.core.entities.Guild;
import net.dv8tion.jda.core.entities.TextChannel;
import net.liveware.discord.Main;
import net.liveware.discord.bridge.endpoint.EndPoint;
import net.liveware.discord.bridge.endpoint.EndPointInfo;
import net.liveware.discord.bridge.endpoint.EndPointMessage;
import net.liveware.discord.bridge.endpoint.EndPointType;
...
public class DiscordEndPoint extends EndPoint
{
    ...
    {
        return Main.getAPI().getGuildById(guildId);
    }
    ...
    {
        return Main.getAPI().getTextChannelById(channelId);
    }
