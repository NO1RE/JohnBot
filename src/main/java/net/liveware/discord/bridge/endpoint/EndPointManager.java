 ...
 */
package net.liveware.discord.bridge.endpoint;

import java.util.ArrayList;
import java.util.List;

import net.liveware.discord.bridge.endpoint.types.DiscordEndPoint;
import net.liveware.discord.bridge.endpoint.types.IrcEndPoint;
