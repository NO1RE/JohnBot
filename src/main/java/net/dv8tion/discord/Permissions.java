...
public class Permissions
{
    ...
    public static final String ADD_TOUHOU_DATABASE = "addTouhouDatabase";
    public static final String GET_TOUHOU_DATABASE = "getTouhouDatabase";
    public static final String REMOVE_TOUHOU_DATABASE = "removeTouhouDatabase";
